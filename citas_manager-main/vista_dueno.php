<?php
 ...
 if(isset($_POST['barberBtn'])){
    $_POST['barber'];
    header('location: registra_establecimiento.php');
    }
 if(isset($_POST['saludBtn'])){
    $_POST['salud'];
    header('location: registra_establecimiento.php');
    }
 if(isset($_POST['comidaBtn'])){
    $_POST['comida'];
    header('location: registra_establecimiento.php');
    }
?>
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="./images/sector_salud.webp" alt="sector salud" class="img-top circular-image">
                    <h5>Sector Salud</h5>
                    <form method='post' action="registra_establecimiento.php">
                        <input type="hidden" name="salud" value='salud'>
                        <button value='barber' name='saludBtn' type='submit' class="btn btn-dark">Registrar establecimiento</button>
                    </form>
            </div>
            ...
            <div class="col-md-4">
                <img src="./images/barber.webp" alt="estilistas" class="img-top circular-image">
                    ...
                    <form method='post' action="registra_establecimiento.php">
                        ...
                        <button value='barber' name='barberBtn' type='submit' class="btn btn-dark">Registrar establecimiento</button>
                    </form>
                </div>
            ...
            <div class="col-md-4">
                <img src="./images/restaurantes.webp" alt="restaurantes" class="img-top circular-image">
                    ...
                    <form method='post' action="registra_establecimiento.php">
                        ...
                        <button value='barber' name='comidaBtn' type='submit' class="btn btn-dark">Agendar cita</button>
                    </form>                   
                </div>
            </div>
        </div>
